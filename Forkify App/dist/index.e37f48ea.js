...
[
    ...
    window.addEventListener(eve, showRecipes);
}); // window.addEventListener('hashchange', showRecipes);

},{"../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime/runtime":"dXNgZ"}],"cMpiy":[function(require,module,exports) {
module.exports = require("86f13637040ebe0d").getBundleURL("hWUTQ") + "icons.21bad73c.svg" + "?" + Date.now();

},{"86f13637040ebe0d":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
